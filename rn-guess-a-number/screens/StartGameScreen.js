...
const StartGameScreen = props => {
    ...
    const [buttonWidth, setButtonWidth] = useState(Dimensions.get('window').width / 4); // window or screen - window excludes the status bar
    ...
    const confirmInputHandler = () => {
        ...
        setEnteredValue(''); // queued till next render cycle, so it can still be used in this cycle
        Keyboard.dismiss();
    };
